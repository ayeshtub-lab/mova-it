...
export default function AppleIcon() {
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: "#0d0e12" }}>
        <svg width="132" height="132" viewBox="0 0 100 100">
          ...
          <path d="M64 46L28 82h56" fill="none" stroke="#5b8dff" strokeWidth="13" strokeLinecap="round" strokeLinejoin="round" />
